...
/*
    ...
    TooltipArea es similar a un Box, pero con la capacidad de mostrar información sobre herramientas.

    Los principales argumentos de la función 'TooltipArea':

     - información sobre herramientas: contenido componible que representa información sobre herramientas
     - tooltipPlacement: describe cómo colocar información sobre herramientas. Puede especificar
       un ancla (el cursor del mouse o el componente), un desplazamiento y una alineación
